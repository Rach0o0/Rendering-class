...
struct Uniforms {
    ...
    frame: f32, progressive: f32, _pad5: f32, _pad6: f32
}; 
...
fn lambertian(r: ptr<function, Ray>, hit: ptr<function, HitInfo>) -> vec3f { 
    ...
    let Le = (*hit).emission; 
    let ambient = 0.05 * kd;
    let lo = ambient + Le + (kd / 3.14159) * light.L_i * n_dot_wi; 
...
{   
    ...
    */
    ...
    fsOut.frame = vec4f(pow(accum_color, vec3f(1.0 / uniforms.gamma)) + jitter_offset, 1.0);
    return fsOut;
}

...
fn intersect_plane(r: ptr<function, Ray>, hit: ptr<function, HitInfo>, position: vec3f, onb:Onb, ambient: vec3f, diffuse:vec3f, specular:vec3f, shade:u32) -> bool {
    ...
    */
    ...
    if (t > (*r).tmin && t < (*r).tmax && t < (*hit).dist) {
        ...
        let scale = uniforms.texture_flags.w * 0.2;
...
fn intersect_scene(r: ptr<function, Ray>, hit: ptr<function, HitInfo>) ->bool {
    ...
    if (intersect_sphere(r, hit, sphere_center, sphere_radius, sphere_ambient, sphere_diffuse, sphere_specular, sphere_shader)) {
        (*hit).object_id = 1u;
    } 
    ...
    if (intersect_triangle(r, hit, v0, v1, v2, tri_ambient, tri_diffuse, tri_specular, tri_shader)) {
        (*hit).object_id = 2u;
    }

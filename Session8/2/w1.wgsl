...
fn transparent(r: ptr<function, Ray>, hit: ptr<function, HitInfo>, t: ptr<function,u32>) -> vec3f {
    ...
    // ABSORPTION
    let sigma = vec3f(0.01, 0.01, 0.01);
    let Tr = exp(-sigma * hit.dist);
    hit.throughput *= Tr;
    ...
    for (var k = 0; k < n; k++) {
        ...
        */
        ...
        for (var depth = 0; depth < 5; depth++){
            ...
            if (hit.shader != SHADER_TRANSPARENT &&
                hit.shader != SHADER_MIRROR &&
                hit.shader != SHADER_REFRACT)
            {
